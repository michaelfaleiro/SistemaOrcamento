...
namespace SistemaOrcamento.Api.Migrations
{
    ...
    [Migration("20240620102801_cotacao")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaOrcamento.Core.Models.Cotacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaOrcamento.Core.Models.CotacaoPrecoProduto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CotacaoProdutoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CotacaoProdutoId");

                    b.HasIndex("FornecedorId");

                    b.ToTable("CotacaoPrecoProdutos");
                });

            modelBuilder.Entity("SistemaOrcamento.Core.Models.CotacaoProduto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CotacaoProdutos");
                });

            modelBuilder.Entity("SistemaOrcamento.Core.Models.Fornecedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaOrcamento.Core.Models.ProdutoAvulso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaOrcamento.Core.Models.CotacaoPrecoProduto", b =>
                {
                    b.HasOne("SistemaOrcamento.Core.Models.CotacaoProduto", "CotacaoProduto")
                        .WithMany("PrecoProdutos")
                        .HasForeignKey("CotacaoProdutoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SistemaOrcamento.Core.Models.Fornecedor", "Fornecedor")
                        .WithMany()
                        .HasForeignKey("FornecedorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CotacaoProduto");
            ...
            modelBuilder.Entity("SistemaOrcamento.Core.Models.CotacaoProduto", b =>
                {
                    b.HasOne("SistemaOrcamento.Core.Models.Cotacao", "Cotacao")
